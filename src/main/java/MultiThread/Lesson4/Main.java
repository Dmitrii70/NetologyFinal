...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        textGenerator.start();
        Thread.sleep(10000);
        System.out.println("Размер очереди А: " + queueA.size());
        System.out.println("Размер очереди B: " + queueB.size());
        System.out.println("Размер очереди C: " + queueC.size());
    ...
    public static Thread getThread(BlockingQueue<String> queue, char letter) {
        return new Thread(() -> {
            ...
            System.out.println("Max quantity of " + letter + " int all texts: " + max);
        });
    }
